...
for sent, stem_sent in zip(doc.sents, doc_stem.sents):
    # verifica se a sentença contém as palavras "objective, aim ou purpose" junto de "study, article ou research"
    if not obj_bool and ("object" in stem_sent.text.lower()) and (("studi" in stem_sent.text.lower() or "research" in stem_sent.text.lower() or "articl" in stem_sent.text.lower())):
        print("\nObjetivo:", sent)
        obj_bool = True
